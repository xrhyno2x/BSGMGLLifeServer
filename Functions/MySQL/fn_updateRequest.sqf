...
switch (_side) do {
    ...
    case east: {_query = format ["UPDATE players SET name='%1', cash='%2', bankacc='%3', rebel_licenses='%4', rebel_gear='%5', rebel_stats='%6', playtime='%7' WHERE pid='%8'",_name,_cash,_bank,_licenses,_gear,_stats,_playtime_update,_uid];};
};
