...
if ((_vInfo select 1) isEqualTo "rebel" && (_vInfo select 2) isEqualTo "C_Offroad_01_F") then {
    [_vehicle,"rebel_offroad",true] remoteExecCall ["life_fnc_vehicleAnimate",_unit];
};
